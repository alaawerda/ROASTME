      ...
      <div className="relative w-full max-w-md mx-4 bg-white/95 backdrop-blur-md rounded-t-3xl sm:rounded-3xl shadow-2xl border border-white/20 transform transition-all duration-300 ease-out animate-in">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200/50">
          <div className="flex items-center space-x-3">
            <div className="w-2 h-2 bg-gradient-to-r from-flame-orange to-purple-dark rounded-full"></div>
            <h3 className="text-xl font-bold text-gray-900">{title}</h3>
          </div>
          <button
            onClick={onClose}
            className="p-2.5 text-gray-400 hover:text-gray-600 transition-all duration-200 ease-out rounded-xl hover:bg-gray-100/80 hover:scale-110"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
